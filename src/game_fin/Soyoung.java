...
public class Soyoung extends JPanel implements ActionListener, Runnable {
	   ...
	   private ImageIcon backButtonEnteredImage = new ImageIcon(Game_end.class.getResource("../images/soyoungBackButtonPressed.png"));
	   private ImageIcon backButtonBasicImage = new ImageIcon(Game_end.class.getResource("../images/soyoungBackButton.png"));
	   ...
	   public void init() {
	    ...
	    // exitButton 만들기
	 	...
	 	add(menuBar, BorderLayout.NORTH);
	      ...
	      //단어가 뜨는 화면 배경
	      wordBack = new ImageIcon(Game_end.class.getResource("../images/background.png"));
	      
	      //캐릭터가 있는 화면 배경
	      gameBack = new ImageIcon(Game_end.class.getResource("../images/집1.png"));
		...
		inputPanel.add(backButton);
	      ...
	      icon1 = new ImageIcon(Game_end.class.getResource("../images/jj1.png"));
	      icon2 = new ImageIcon(Game_end.class.getResource("../images/jj2.png"));
	      icon3 = new ImageIcon(Game_end.class.getResource("../images/jj3.png"));
	      icon4 = new ImageIcon(Game_end.class.getResource("../images/jj4.png"));
	      icon5 = new ImageIcon(Game_end.class.getResource("../images/jj5.png"));
	      icon6 = new ImageIcon(Game_end.class.getResource("../images/jj6.png"));
	   ...
	   public void changeImg() {
	      if (score < 71) {
	         ...
	         age = 1;
	         gameBack = new ImageIcon(Game_end.class.getResource("../images/집2-1.png"));
	         imgLabel.setIcon(chgIcon2);
	      } else if (score < 103) {
	         age = 2;
	         gameBack = new ImageIcon(Game_end.class.getResource("../images/집3.png"));
	         imgLabel.setIcon(chgIcon3);
	      } else if (score < 119) {
	         age = 3;
	         gameBack = new ImageIcon(Game_end.class.getResource("../images/집4.png"));
	         imgLabel.setIcon(chgIcon4);
	      } else if (score < 135) {
	         age = 4;
	         gameBack = new ImageIcon(Game_end.class.getResource("../images/집5.png"));
	         imgLabel.setIcon(chgIcon5);
	      } else if (score < 151) {
	         age = 5;
	         gameBack = new ImageIcon(Game_end.class.getResource("../images/집6-1.png"));
	         imgLabel.setIcon(chgIcon6);
	      } else if (score == 151) {
	         check = false;
	         timer = 20; //
	         gameBack = new ImageIcon(Game_end.class.getResource("../images/end.jpg"));
